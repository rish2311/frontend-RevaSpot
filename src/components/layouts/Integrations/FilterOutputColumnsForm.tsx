...
const FilterOutputColumnsForm = ({
  ...
  return (
    <div className='flex flex-col'>
      <h3 className='text-lg font-semibold'>Filter Output Columns</h3>
      <p className='py-4 text-sm'>We will enrich the data for these columns</p>
      <Form {...form}>
        <form
...
export default FilterOutputColumnsForm
