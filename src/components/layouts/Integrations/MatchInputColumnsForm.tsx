...
const MatchInputColumnsForm = ({
  ...
  return (
    <div className='flex flex-col'>
      <h3 className='text-lg font-semibold'>Match Input Columns with CRM</h3>
      <p className='py-4 text-sm'>Map Revspot required fields with fields in your CRM</p>
      <Form {...form}>
        <form
...
export default MatchInputColumnsForm
